        ...
        <section id="s01">
            <div id="carousel01" class="carousel slide carousel-fade" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item bg-cover  active" style="background-image: url(images/新北/竹北星際球場/Copy\ of\ DSC_0215-HDR.JPG); height: 90vh;">
                    </div>
                    <div class="carousel-item bg-cover" style="background-image: url(images/24超體/職業組E5/DSC08478.JPG); height: 90vh;">
                    </div>
                    <div class="carousel-item bg-cover" style="background-image: url(images/24wepower/20240921_WE\ POWER-39.jpg); height: 90vh;">
                    </div>
                </div>
